            ...
            <div class="journey-layout">
              <div class="journey-main">
                ...
                <section class="journey-glass journey-timeline"><h2>我的旅程时间线　<small>全部事件⌄</small></h2><div class="timeline-list-new" id="timeline">
                  <article class="timeline-row-new"><div class="timeline-date"><b>5/18</b><small>周六</small></div><img src="./assets/journey/icons/milestone-sprout.svg" alt=""><div class="timeline-copy"><b>头皮健康评分提升</b><small>你的头皮健康评分从 72 提升到 82，继续保持哦！</small></div><span class="timeline-reward green">82 分</span></article>
                  <article class="timeline-row-new"><div class="timeline-date"><b>5/15</b><small>周三</small></div><img src="./assets/journey/icons/timeline-moon.svg" alt=""><div class="timeline-copy"><b>早睡打卡</b><small>你在 22:30 前入睡，睡眠质量很棒！</small></div><span class="timeline-reward">76 分</span></article>
                  <article class="timeline-row-new selected"><div class="timeline-date"><b>5/12</b><small>周日</small></div><img src="./assets/journey/icons/timeline-streak.svg" alt=""><div class="timeline-copy"><b>连续打卡 7 天</b><small>太棒了！你已经连续 7 天坚持记录和护理！</small></div><span class="timeline-reward green">88 分</span></article>
                  <article class="timeline-row-new"><div class="timeline-date"><b>5/10</b><small>周五</small></div><img src="./assets/journey/icons/timeline-food.svg" alt=""><div class="timeline-copy"><b>健康饮食</b><small>你记录了健康餐饮，营养均衡，头发需要的能量满满！</small></div><span class="timeline-reward">71 分</span></article>
                  <article class="timeline-row-new"><div class="timeline-date"><b>5/8</b><small>周三</small></div><img src="./assets/journey/icons/timeline-exercise.svg" alt=""><div class="timeline-copy"><b>运动 20 分钟</b><small>运动可以促进血液循环，头发会更健康哦！</small></div><span class="timeline-reward">69 分</span></article>
                  <article class="timeline-row-new"><div class="timeline-date"><b>5/7</b><small>周二</small></div><img src="./assets/journey/icons/milestone-task.svg" alt=""><div class="timeline-copy"><b>完成第一个任务</b><small>你完成了“头皮按摩 5 分钟”任务，真棒！</small></div><span class="timeline-reward green">80 分</span></article>
