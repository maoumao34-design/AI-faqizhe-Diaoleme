          ...
          <div class="grid two-col">
            <div class="grid">
              <section class="league-season-hero">
                <img class="league-hero-sky" src="./league-assets/sky-bg.svg" alt="" aria-hidden="true">
                <img class="league-hero-flowers" src="./league-assets/flower-fg.svg" alt="" aria-hidden="true">
                ...
                <div class="league-hero-characters" aria-label="赛季前三名">
                  <div class="podium second">
                    <img class="podium-char" src="./league-assets/champion-2.svg" alt="亚军">
                    <img class="podium-base" src="./league-assets/podium-2.svg" alt="">
                  </div>
                  <div class="podium first">
                    <img class="podium-char" src="./league-assets/champion-1.svg" alt="冠军">
                    <img class="podium-base" src="./league-assets/podium-1.svg" alt="">
                  </div>
                  <div class="podium third">
                    <img class="podium-char" src="./league-assets/champion-3.svg" alt="季军">
                    <img class="podium-base" src="./league-assets/podium-3.svg" alt="">
                  </div>
                </div>
                <div class="league-hero-rank">
                  <button type="button">🎁 赛季奖励预览</button>
                  <span>我的段位</span>
                  <img class="league-hero-badge" src="./league-assets/shield-diamond.svg" alt="段位徽章">
            ...
            <aside class="league-right-rail">
              <section class="league-side-panel alliance-panel">
                ...
                <div class="league-alliance-main"><img class="league-shield-placeholder" src="./league-assets/badge-ally.svg" alt="联盟徽章"><div><b>蒲公英小分队 <em>Lv.6</em></b><span>Lv.5</span></div></div>
              ...
              <section class="league-side-panel battle-panel">
                ...
                <div class="league-battle-grid">
                  <div><img class="league-battle-badge" src="./league-assets/badge-ally-sm.svg" alt="我方"><b>蒲公英小分队</b><strong>15,680</strong></div>
                  <img class="league-vs" src="./league-assets/vs-mark.svg" alt="VS">
                  <div><img class="league-battle-badge" src="./league-assets/badge-enemy-sm.svg" alt="对手"><b>发光小队</b><strong>12,420</strong></div>
                </div>
              ...
              <section class="league-side-panel awards-panel">
                ...
                <div class="league-awards-grid">
                  <div><img class="award-dot" src="./league-assets/honor-hair.svg" alt="护发达人"><b>护发达人</b><small>Luna</small></div>
                  <div><img class="award-dot" src="./league-assets/honor-love.svg" alt="爱心大使"><b>爱心大使</b><small>Mia</small></div>
                  <div><img class="award-dot" src="./league-assets/honor-active.svg" alt="活跃之星"><b>活跃之星</b><small>Ray</small></div>
                </div>
              </section>
            </aside>
          </div>
